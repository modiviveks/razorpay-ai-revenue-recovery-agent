...
class PaymentEvent(Base):
    ...
    __table_args__ = (UniqueConstraint("webhook_event_id", name="uq_payment_events_webhook_event_id"),)
...
class RecoveryAction(Base):
    ...
    expected_recovery_amount = Column(Integer, nullable=True)
...
class AuditLog(Base):
    ...
    api_call = Column(Text, nullable=True)
