...
def determine_strategy(
    ...
    # Check if NO_ACTION was explicitly proposed due to negative EV or zero recovery value
    if proposed_strategy == RecoveryStrategy.NO_ACTION:
        return StrategyResult(
            strategy=RecoveryStrategy.NO_ACTION,
            status=ActionStatus.SKIPPED,
            max_retries=0,
            is_bounded=True,
            rationale="Do nothing because expected recovery value is lower than intervention cost/friction."
        )
